...
public class MetodosString {
    ...
    public static void menu()
    {
        String aux;
         ...
         System.out.println("Ingrese el caracter a buscar en el texto, si ingresa mas de un caracter por error, el sistema considerara el primero ingresado.");
         aux=entrada.next();
         caracter=aux.charAt(0);
         existechar=existeChar(palabra,caracter);
       
         System.out.println("Ingrese el sub texto a buscar en el texto ingresado inicialmente");
